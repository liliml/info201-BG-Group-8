  ...
  sidebarLayout(
    ...
    mainPanel(
      tabsetPanel(
        ...
        p("Comparing the four streaming service histograms, all streaming services have a variety of ratings and mostly follow a normal distribution shape.
        ...
        p("An explanation for this could be that the size of Netflix's catalog is much larger than Hulu, almost having 1500 more movies.
